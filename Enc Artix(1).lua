...
local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KB = ]]..KB..[[  local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KKB = ]]..KKB..[[  local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KKBB = ]]..KKBB..[[  local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KBKBK = ]]..KBKBK..[[  local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KA = ]]..KA..[[  local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KKA = ]]..KKA..[[  local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KKAA = ]]..KKAA..[[  local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KAKAK = ]]..KAKAK..[[  local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KC = ]]..KC..[[  local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KKC = ]]..KKC..[[  local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KKCC = ]]..KKCC..[[  local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KCKCK = ]]..KCKCK..[[  local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KD = ]]..KD..[[  local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KKD = ]]..KKD..[[  local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KKDD = ]]..KKDD..[[  local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KDKDK = ]]..KDKDK..[[  local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KE = ]]..KE..[[  local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KKE = ]]..KKE..[[  local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KKEE = ]]..KKEE..[[  local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KEKEK = ]]..KEKEK..[[  local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end 
local TBLKEY = {KKEE + (KKDD - KKAA),KKCC * (2 + KKBB),(KA + KB) * KE,KD - KC,KKC * 20 + KKB,KKD + KKA - KKE,KBKBK * (9 + KAKAK),KEKEK - KDKDK * KCKCK} local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local TBLKEY2 = {TBLKEY[1] + KEKEK,TBLKEY[4] * (TBLKEY[7] + KAKAK),KCKCK + KKB * TBLKEY[8],TBLKEY[3] + KE,KA * KD + KC,TBLKEY[2] * KKEE,TBLKEY[1] * TBLKEY[6],KKEE + KKDD - KA + KC} local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local TBLKEY3 = {TBLKEY[1] * TBLKEY2[2],TBLKEY[2] - KAKAK * TBLKEY2[7] + (TBLKEY2[4] - KKE),TBLKEY2[5] * TBLKEY[7] + TBLKEY2[8],TBLKEY[4] + KE * KA - (KD + TBLKEY2[4]),TBLKEY2[1] + TBLKEY[2] - TBLKEY2[3] + TBLKEY[6]} local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KEY1 = {TBLKEY3[5] - (TBLKEY[7] + TBLKEY2[2])} local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KEY2 = {TBLKEY[2] * TBLKEY3[3] - KEKEK} local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KEY3 = {(TBLKEY3[4] * 4) - 97} local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KEY4 = {TBLKEY3[2] + 94} local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KEY5 = {KEKEK + TBLKEY2[8] - TBLKEY3[4]} local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KEY6 = {TBLKEY[1] + TBLKEY2[2] - TBLKEY3[3]} local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KEY7 = {TBLKEY3[4] - TBLKEY2[3]} local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KEY8 = {KA + TBLKEY2[7]} local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KEY9 = {TBLKEY[2] + TBLKEY[8]} local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KEY10 = {KAKAK + TBLKEY2[5]} local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KEY11 = {TBLKEY2[1] + TBLKEY3[4] - TBLKEY[4] - TBLKEY[7] - TBLKEY[5]} local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KEY12 = {TBLKEY2[7] + TBLKEY[2]} local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KEY13 = {TBLKEY3[4] - 964} local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KEY14 = {TBLKEY3[5] - TBLKEY[1] + KD} local ____ = ___("ARTIX") for i = 1,0 do artix = "chunk" end while(nil)do;local i={}if(i.i)then;i.i=(i.i(i));end;end local KEY15 = {TBLKEY2[4] + 465 - KE - KD} 
local DATABLE = {}
gg.setVisible(false)
gg.toast(" Eɴᴄʀʏᴘᴛɪᴏɴ Bʏ GAMATARU ") 
