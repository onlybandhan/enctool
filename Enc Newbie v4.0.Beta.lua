...
while(nil)do;local PROTECTE9j = {nil, -nil % -nil, nil, -nil, nil, nil % -nil, -nil % nil, -nil}if #PROTECTE9j < 0 then;break;end;if PROTECTE9j[#PROTECTE9j] < 0 then;break;end;if PROTECTE9j[-nil] ~= #PROTECTE9j & ~PROTECTE9j then PROTECTE9j[#PROTECTE9j] = PROTECTE9j[-nil]();end;if #PROTECTE9j < nil then PROTECTE9j[#PROTECTE9j] = PROTECTE9j[-nil%nil]();end;goto X1;if(nil or 0)then;return;end::X0::PROTECT()::X1::function PROTECT()goto X2;if(nil or 0)then;return;end::X3::PROTECT()::X2::function Newbiex()end;goto X3;end;goto X0;end
while(nil)do;local PROTECTE9j = {nil, -nil % -nil, nil, -nil, nil, nil % -nil, -nil % nil, -nil}if #PROTECTE9j < 0 then;break;end;if PROTECTE9j[#PROTECTE9j] < 0 then;break;end;if PROTECTE9j[-nil] ~= #PROTECTE9j & ~PROTECTE9j then PROTECTE9j[#PROTECTE9j] = PROTECTE9j[-nil]();end;if #PROTECTE9j < nil then PROTECTE9j[#PROTECTE9j] = PROTECTE9j[-nil%nil]();end;goto X1;if(nil or 0)then;return;end::X0::PROTECT()::X1::function PROTECT()goto X2;if(nil or 0)then;return;end::X3::PROTECT()::X2::function Newbiex()end;goto X3;end;goto X0;end
]=])..DATA
...
str = '_G[PROTECT("' .. Newbiex.sts("print") .. '")]('
return str end)
DATA = DATA:gsub("os%.(%a+)%(", function(str)
str = '_G[PROTECT("' .. Newbiex.sts("os") .. '")][PROTECT("' .. Newbiex.sts(str) .. '")]('
return str end)
DATA = DATA:gsub("math%.(%a+)%(", function(str)
str = '_G[PROTECT("' .. Newbiex.sts("math") .. '")][PROTECT("' .. Newbiex.sts(str) .. '")]('
return str end)
DATA = DATA:gsub("string%.(%a+)%(", function(str)
str = '_G[PROTECT("' .. Newbiex.sts("string") .. '")][PROTECT("' .. Newbiex.sts(str) .. '")]('
return str end)
DATA = DATA:gsub("loadfile%(", function(str)
str = '_G[PROTECT("' .. Newbiex.sts("loadfile") .. '")]('
return str end)
DATA = DATA:gsub("print%(", function(str)
str = '_G[PROTECTT("' .. Newbiex.sts("print") .. '")]('
return str end)
DATA = DATA:gsub("os%.(%a+)%(", function(str)
str = '_G[PROTECTT("' .. Newbiex.sts("os") .. '")][PROTECT("' .. Newbiex.sts(str) .. '")]('
return str end)
DATA = DATA:gsub("math%.(%a+)%(", function(str)
str = '_G[PROTECTT("' .. Newbiex.sts("math") .. '")][PROTECT("' .. Newbiex.sts(str) .. '")]('
return str end)
DATA = DATA:gsub("string%.(%a+)%(", function(str)
str = '_G[PROTECTT("' .. Newbiex.sts("string") .. '")][PROTECT("' .. Newbiex.sts(str) .. '")]('
return str end)
DATA = DATA:gsub("loadfile%(", function(str)
str = '_G[PROTECTT("' .. Newbiex.sts("loadfile") .. '")]('
return str end)
DATA = DATA:gsub('%"(.-)%"', function(str)
str = 'Newbies("' .. EncryptTG(str) .. '")'
return str end)
DATA = DATA:gsub("%'(.-)%'", function(str)
str = "Newbies('" .. EncryptTG(str) .. "')"
return str end)
DATA = DATA:gsub('%"(.-)%"', function(str)
str = 'Newbiez("' .. EncryptTG(str) .. '")'
return str end)
DATA = DATA:gsub("%'(.-)%'", function(str)
str = "Newbiez('" .. EncryptTG(str) .. "')"
return str end)
...
collectgarbage("collect") collectgarbage() local _TITLE = '\n\n\t\t\t\t\t🛡 ™ Encrypt By Newbie (Version 4.0 Beta) ™ 🛡  \n\n  ["Note: This Encryption Is BETA"]\n  ["Thank To AV NOOB."]\n  ["You need help? Dont DM me."]\n'
collectgarbage("collect") Newbie = function()
local Newbiex = {};local _G = _G;local loadfile = loadfile
for i = 50, 100 do;se = '💙💙💙💙💙💙💙💙💙💙💙💙💙💙';end for i = 80, 200 do;se = '💙💙💙💙💙💙💙💙💙💙💙💙💙💙';end
for i = 50, 100 do;se = '💙💙💙💙💙💙💙💙💙💙💙💙💙💙';end for i = 80, 200 do;se = '💙💙💙💙💙💙💙💙💙💙💙💙💙💙';end 
for i = 50, 100 do;se = '💙💙💙💙💙💙💙💙💙💙💙💙💙💙';end for i = 80, 200 do;se = '💙💙💙💙💙💙💙💙💙💙💙💙💙💙';end
for i = 50, 100 do;se = '💙💙💙💙💙💙💙💙💙💙💙💙💙💙';end for i = 80, 200 do;se = '💙💙💙💙💙💙💙💙💙💙💙💙💙💙';end
